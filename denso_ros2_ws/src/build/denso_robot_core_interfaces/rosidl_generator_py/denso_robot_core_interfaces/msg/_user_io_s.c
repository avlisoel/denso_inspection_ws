...
bool denso_robot_core_interfaces__msg__user_io__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("denso_robot_core_interfaces.msg._user_io.UserIO", full_classname_dest, 47) == 0);
  }
  denso_robot_core_interfaces__msg__UserIO * ros_message = _ros_message;
  {  // offset
...
{
  /* NOTE(esteve): Call constructor of UserIO */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("denso_robot_core_interfaces.msg._user_io");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UserIO");
