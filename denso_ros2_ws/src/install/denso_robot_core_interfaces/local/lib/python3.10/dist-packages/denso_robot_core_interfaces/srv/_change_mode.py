...
class Metaclass_ChangeMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'denso_robot_core_interfaces.srv.ChangeMode')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from denso_robot_core_interfaces.srv import _change_mode
...
class ChangeMode(metaclass=Metaclass_ChangeMode):
    from denso_robot_core_interfaces.srv._change_mode import ChangeMode_Request as Request
    from denso_robot_core_interfaces.srv._change_mode import ChangeMode_Response as Response
