...
bool denso_robot_core_interfaces__msg__joints__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("denso_robot_core_interfaces.msg._joints.Joints", full_classname_dest, 46) == 0);
  }
  denso_robot_core_interfaces__msg__Joints * ros_message = _ros_message;
  {  // joint
...
PyObject * denso_robot_core_interfaces__msg__joints__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("denso_robot_core_interfaces.msg._joints");
