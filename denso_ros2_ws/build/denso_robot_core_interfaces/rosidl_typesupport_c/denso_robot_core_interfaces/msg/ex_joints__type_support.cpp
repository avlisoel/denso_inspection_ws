...
static const _ExJoints_type_support_symbol_names_t _ExJoints_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, denso_robot_core_interfaces, msg, ExJoints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, denso_robot_core_interfaces, msg, ExJoints)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, denso_robot_core_interfaces, msg, ExJoints)() {
  return &::denso_robot_core_interfaces::msg::rosidl_typesupport_c::ExJoints_message_type_support_handle;
}
