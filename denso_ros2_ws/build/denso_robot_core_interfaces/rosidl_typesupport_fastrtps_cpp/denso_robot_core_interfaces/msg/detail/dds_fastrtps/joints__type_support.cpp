...
#include "denso_robot_core_interfaces/msg/detail/joints__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const denso_robot_core_interfaces::msg::Joints & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  denso_robot_core_interfaces::msg::Joints & ros_message)
{
  // Member: joint
  cdr >> ros_message.joint;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = denso_robot_core_interfaces::msg::Joints;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const denso_robot_core_interfaces::msg::Joints *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<denso_robot_core_interfaces::msg::Joints *>(
    untyped_ros_message);
...
{
  return &denso_robot_core_interfaces::msg::typesupport_fastrtps_cpp::_Joints__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, denso_robot_core_interfaces, msg, Joints)() {
  return &denso_robot_core_interfaces::msg::typesupport_fastrtps_cpp::_Joints__handle;
}
