...
denso_robot_core_interfaces__action__MoveValue_Goal__init(denso_robot_core_interfaces__action__MoveValue_Goal * msg)
{
  ...
  // comp
  // pose
  if (!denso_robot_core_interfaces__msg__PoseData__init(&msg->pose)) {
    denso_robot_core_interfaces__action__MoveValue_Goal__fini(msg);
    return false;
  }
  // option
...
denso_robot_core_interfaces__action__MoveValue_Goal__fini(denso_robot_core_interfaces__action__MoveValue_Goal * msg)
{
  ...
  // comp
  // pose
  denso_robot_core_interfaces__msg__PoseData__fini(&msg->pose);
  // option
...
denso_robot_core_interfaces__action__MoveValue_Goal__are_equal(const denso_robot_core_interfaces__action__MoveValue_Goal * lhs, const denso_robot_core_interfaces__action__MoveValue_Goal * rhs)
{
  ...
  // pose
  if (!denso_robot_core_interfaces__msg__PoseData__are_equal(
      &(lhs->pose), &(rhs->pose)))
  {
    return false;
  }
...
denso_robot_core_interfaces__action__MoveValue_Goal__create()
{
  ...
  denso_robot_core_interfaces__action__MoveValue_Goal * msg = (denso_robot_core_interfaces__action__MoveValue_Goal *)allocator.allocate(sizeof(denso_robot_core_interfaces__action__MoveValue_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(denso_robot_core_interfaces__action__MoveValue_Goal));
  bool success = denso_robot_core_interfaces__action__MoveValue_Goal__init(msg);
  if (!success) {
...
denso_robot_core_interfaces__action__MoveValue_Goal__Sequence__init(denso_robot_core_interfaces__action__MoveValue_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_Goal * data = NULL;

  if (size) {
    data = (denso_robot_core_interfaces__action__MoveValue_Goal *)allocator.zero_allocate(size, sizeof(denso_robot_core_interfaces__action__MoveValue_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = denso_robot_core_interfaces__action__MoveValue_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        denso_robot_core_interfaces__action__MoveValue_Goal__fini(&data[i - 1]);
      }
...
denso_robot_core_interfaces__action__MoveValue_Goal__Sequence__fini(denso_robot_core_interfaces__action__MoveValue_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      denso_robot_core_interfaces__action__MoveValue_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_Goal__Sequence * array = (denso_robot_core_interfaces__action__MoveValue_Goal__Sequence *)allocator.allocate(sizeof(denso_robot_core_interfaces__action__MoveValue_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = denso_robot_core_interfaces__action__MoveValue_Goal__Sequence__init(array, size);
  if (!success) {
...
denso_robot_core_interfaces__action__MoveValue_Goal__Sequence__destroy(denso_robot_core_interfaces__action__MoveValue_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    denso_robot_core_interfaces__action__MoveValue_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
denso_robot_core_interfaces__action__MoveValue_Goal__Sequence__are_equal(const denso_robot_core_interfaces__action__MoveValue_Goal__Sequence * lhs, const denso_robot_core_interfaces__action__MoveValue_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!denso_robot_core_interfaces__action__MoveValue_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  denso_robot_core_interfaces__action__MoveValue_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(denso_robot_core_interfaces__action__MoveValue_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    denso_robot_core_interfaces__action__MoveValue_Goal * data =
      (denso_robot_core_interfaces__action__MoveValue_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!denso_robot_core_interfaces__action__MoveValue_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          denso_robot_core_interfaces__action__MoveValue_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!denso_robot_core_interfaces__action__MoveValue_Goal__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_Result * msg = (denso_robot_core_interfaces__action__MoveValue_Result *)allocator.allocate(sizeof(denso_robot_core_interfaces__action__MoveValue_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(denso_robot_core_interfaces__action__MoveValue_Result));
  bool success = denso_robot_core_interfaces__action__MoveValue_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
denso_robot_core_interfaces__action__MoveValue_Result__destroy(denso_robot_core_interfaces__action__MoveValue_Result * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    denso_robot_core_interfaces__action__MoveValue_Result__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
denso_robot_core_interfaces__action__MoveValue_Result__Sequence__init(denso_robot_core_interfaces__action__MoveValue_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_Result * data = NULL;

  if (size) {
    data = (denso_robot_core_interfaces__action__MoveValue_Result *)allocator.zero_allocate(size, sizeof(denso_robot_core_interfaces__action__MoveValue_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = denso_robot_core_interfaces__action__MoveValue_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        denso_robot_core_interfaces__action__MoveValue_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
denso_robot_core_interfaces__action__MoveValue_Result__Sequence__fini(denso_robot_core_interfaces__action__MoveValue_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      denso_robot_core_interfaces__action__MoveValue_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_Result__Sequence * array = (denso_robot_core_interfaces__action__MoveValue_Result__Sequence *)allocator.allocate(sizeof(denso_robot_core_interfaces__action__MoveValue_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = denso_robot_core_interfaces__action__MoveValue_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
denso_robot_core_interfaces__action__MoveValue_Result__Sequence__destroy(denso_robot_core_interfaces__action__MoveValue_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    denso_robot_core_interfaces__action__MoveValue_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
denso_robot_core_interfaces__action__MoveValue_Result__Sequence__are_equal(const denso_robot_core_interfaces__action__MoveValue_Result__Sequence * lhs, const denso_robot_core_interfaces__action__MoveValue_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!denso_robot_core_interfaces__action__MoveValue_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  denso_robot_core_interfaces__action__MoveValue_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(denso_robot_core_interfaces__action__MoveValue_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    denso_robot_core_interfaces__action__MoveValue_Result * data =
      (denso_robot_core_interfaces__action__MoveValue_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!denso_robot_core_interfaces__action__MoveValue_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          denso_robot_core_interfaces__action__MoveValue_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!denso_robot_core_interfaces__action__MoveValue_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
denso_robot_core_interfaces__action__MoveValue_Feedback__init(denso_robot_core_interfaces__action__MoveValue_Feedback * msg)
{
  ...
  if (!rosidl_runtime_c__double__Sequence__init(&msg->pose, 0)) {
    denso_robot_core_interfaces__action__MoveValue_Feedback__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_Feedback * msg = (denso_robot_core_interfaces__action__MoveValue_Feedback *)allocator.allocate(sizeof(denso_robot_core_interfaces__action__MoveValue_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(denso_robot_core_interfaces__action__MoveValue_Feedback));
  bool success = denso_robot_core_interfaces__action__MoveValue_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
denso_robot_core_interfaces__action__MoveValue_Feedback__Sequence__init(denso_robot_core_interfaces__action__MoveValue_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_Feedback * data = NULL;

  if (size) {
    data = (denso_robot_core_interfaces__action__MoveValue_Feedback *)allocator.zero_allocate(size, sizeof(denso_robot_core_interfaces__action__MoveValue_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = denso_robot_core_interfaces__action__MoveValue_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        denso_robot_core_interfaces__action__MoveValue_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
denso_robot_core_interfaces__action__MoveValue_Feedback__Sequence__fini(denso_robot_core_interfaces__action__MoveValue_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      denso_robot_core_interfaces__action__MoveValue_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_Feedback__Sequence * array = (denso_robot_core_interfaces__action__MoveValue_Feedback__Sequence *)allocator.allocate(sizeof(denso_robot_core_interfaces__action__MoveValue_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = denso_robot_core_interfaces__action__MoveValue_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
denso_robot_core_interfaces__action__MoveValue_Feedback__Sequence__destroy(denso_robot_core_interfaces__action__MoveValue_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    denso_robot_core_interfaces__action__MoveValue_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
denso_robot_core_interfaces__action__MoveValue_Feedback__Sequence__are_equal(const denso_robot_core_interfaces__action__MoveValue_Feedback__Sequence * lhs, const denso_robot_core_interfaces__action__MoveValue_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!denso_robot_core_interfaces__action__MoveValue_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  denso_robot_core_interfaces__action__MoveValue_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(denso_robot_core_interfaces__action__MoveValue_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    denso_robot_core_interfaces__action__MoveValue_Feedback * data =
      (denso_robot_core_interfaces__action__MoveValue_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!denso_robot_core_interfaces__action__MoveValue_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          denso_robot_core_interfaces__action__MoveValue_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!denso_robot_core_interfaces__action__MoveValue_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__init(denso_robot_core_interfaces__action__MoveValue_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!denso_robot_core_interfaces__action__MoveValue_Goal__init(&msg->goal)) {
    denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__fini(denso_robot_core_interfaces__action__MoveValue_SendGoal_Request * msg)
{
  ...
  // goal
  denso_robot_core_interfaces__action__MoveValue_Goal__fini(&msg->goal);
}
...
denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__are_equal(const denso_robot_core_interfaces__action__MoveValue_SendGoal_Request * lhs, const denso_robot_core_interfaces__action__MoveValue_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!denso_robot_core_interfaces__action__MoveValue_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_SendGoal_Request * msg = (denso_robot_core_interfaces__action__MoveValue_SendGoal_Request *)allocator.allocate(sizeof(denso_robot_core_interfaces__action__MoveValue_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(denso_robot_core_interfaces__action__MoveValue_SendGoal_Request));
  bool success = denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__Sequence__init(denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_SendGoal_Request * data = NULL;

  if (size) {
    data = (denso_robot_core_interfaces__action__MoveValue_SendGoal_Request *)allocator.zero_allocate(size, sizeof(denso_robot_core_interfaces__action__MoveValue_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__Sequence__fini(denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__Sequence * array = (denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__Sequence *)allocator.allocate(sizeof(denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__Sequence__destroy(denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__Sequence__are_equal(const denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__Sequence * lhs, const denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(denso_robot_core_interfaces__action__MoveValue_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    denso_robot_core_interfaces__action__MoveValue_SendGoal_Request * data =
      (denso_robot_core_interfaces__action__MoveValue_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!denso_robot_core_interfaces__action__MoveValue_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__init(denso_robot_core_interfaces__action__MoveValue_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_SendGoal_Response * msg = (denso_robot_core_interfaces__action__MoveValue_SendGoal_Response *)allocator.allocate(sizeof(denso_robot_core_interfaces__action__MoveValue_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(denso_robot_core_interfaces__action__MoveValue_SendGoal_Response));
  bool success = denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__Sequence__init(denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_SendGoal_Response * data = NULL;

  if (size) {
    data = (denso_robot_core_interfaces__action__MoveValue_SendGoal_Response *)allocator.zero_allocate(size, sizeof(denso_robot_core_interfaces__action__MoveValue_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__Sequence__fini(denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__Sequence * array = (denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__Sequence *)allocator.allocate(sizeof(denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__Sequence__destroy(denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__Sequence__are_equal(const denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__Sequence * lhs, const denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(denso_robot_core_interfaces__action__MoveValue_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    denso_robot_core_interfaces__action__MoveValue_SendGoal_Response * data =
      (denso_robot_core_interfaces__action__MoveValue_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!denso_robot_core_interfaces__action__MoveValue_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
denso_robot_core_interfaces__action__MoveValue_GetResult_Request__init(denso_robot_core_interfaces__action__MoveValue_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    denso_robot_core_interfaces__action__MoveValue_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_GetResult_Request * msg = (denso_robot_core_interfaces__action__MoveValue_GetResult_Request *)allocator.allocate(sizeof(denso_robot_core_interfaces__action__MoveValue_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(denso_robot_core_interfaces__action__MoveValue_GetResult_Request));
  bool success = denso_robot_core_interfaces__action__MoveValue_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
denso_robot_core_interfaces__action__MoveValue_GetResult_Request__Sequence__init(denso_robot_core_interfaces__action__MoveValue_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_GetResult_Request * data = NULL;

  if (size) {
    data = (denso_robot_core_interfaces__action__MoveValue_GetResult_Request *)allocator.zero_allocate(size, sizeof(denso_robot_core_interfaces__action__MoveValue_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = denso_robot_core_interfaces__action__MoveValue_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        denso_robot_core_interfaces__action__MoveValue_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
denso_robot_core_interfaces__action__MoveValue_GetResult_Request__Sequence__fini(denso_robot_core_interfaces__action__MoveValue_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      denso_robot_core_interfaces__action__MoveValue_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_GetResult_Request__Sequence * array = (denso_robot_core_interfaces__action__MoveValue_GetResult_Request__Sequence *)allocator.allocate(sizeof(denso_robot_core_interfaces__action__MoveValue_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = denso_robot_core_interfaces__action__MoveValue_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
denso_robot_core_interfaces__action__MoveValue_GetResult_Request__Sequence__destroy(denso_robot_core_interfaces__action__MoveValue_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    denso_robot_core_interfaces__action__MoveValue_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
denso_robot_core_interfaces__action__MoveValue_GetResult_Request__Sequence__are_equal(const denso_robot_core_interfaces__action__MoveValue_GetResult_Request__Sequence * lhs, const denso_robot_core_interfaces__action__MoveValue_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!denso_robot_core_interfaces__action__MoveValue_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  denso_robot_core_interfaces__action__MoveValue_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(denso_robot_core_interfaces__action__MoveValue_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    denso_robot_core_interfaces__action__MoveValue_GetResult_Request * data =
      (denso_robot_core_interfaces__action__MoveValue_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!denso_robot_core_interfaces__action__MoveValue_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          denso_robot_core_interfaces__action__MoveValue_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!denso_robot_core_interfaces__action__MoveValue_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
denso_robot_core_interfaces__action__MoveValue_GetResult_Response__init(denso_robot_core_interfaces__action__MoveValue_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!denso_robot_core_interfaces__action__MoveValue_Result__init(&msg->result)) {
    denso_robot_core_interfaces__action__MoveValue_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
denso_robot_core_interfaces__action__MoveValue_GetResult_Response__fini(denso_robot_core_interfaces__action__MoveValue_GetResult_Response * msg)
{
  ...
  // status
  // result
  denso_robot_core_interfaces__action__MoveValue_Result__fini(&msg->result);
}
...
denso_robot_core_interfaces__action__MoveValue_GetResult_Response__are_equal(const denso_robot_core_interfaces__action__MoveValue_GetResult_Response * lhs, const denso_robot_core_interfaces__action__MoveValue_GetResult_Response * rhs)
{
  ...
  // result
  if (!denso_robot_core_interfaces__action__MoveValue_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_GetResult_Response * msg = (denso_robot_core_interfaces__action__MoveValue_GetResult_Response *)allocator.allocate(sizeof(denso_robot_core_interfaces__action__MoveValue_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(denso_robot_core_interfaces__action__MoveValue_GetResult_Response));
  bool success = denso_robot_core_interfaces__action__MoveValue_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
denso_robot_core_interfaces__action__MoveValue_GetResult_Response__Sequence__init(denso_robot_core_interfaces__action__MoveValue_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_GetResult_Response * data = NULL;

  if (size) {
    data = (denso_robot_core_interfaces__action__MoveValue_GetResult_Response *)allocator.zero_allocate(size, sizeof(denso_robot_core_interfaces__action__MoveValue_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = denso_robot_core_interfaces__action__MoveValue_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        denso_robot_core_interfaces__action__MoveValue_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
denso_robot_core_interfaces__action__MoveValue_GetResult_Response__Sequence__fini(denso_robot_core_interfaces__action__MoveValue_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      denso_robot_core_interfaces__action__MoveValue_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_GetResult_Response__Sequence * array = (denso_robot_core_interfaces__action__MoveValue_GetResult_Response__Sequence *)allocator.allocate(sizeof(denso_robot_core_interfaces__action__MoveValue_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = denso_robot_core_interfaces__action__MoveValue_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
denso_robot_core_interfaces__action__MoveValue_GetResult_Response__Sequence__destroy(denso_robot_core_interfaces__action__MoveValue_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    denso_robot_core_interfaces__action__MoveValue_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
denso_robot_core_interfaces__action__MoveValue_GetResult_Response__Sequence__are_equal(const denso_robot_core_interfaces__action__MoveValue_GetResult_Response__Sequence * lhs, const denso_robot_core_interfaces__action__MoveValue_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!denso_robot_core_interfaces__action__MoveValue_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  denso_robot_core_interfaces__action__MoveValue_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(denso_robot_core_interfaces__action__MoveValue_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    denso_robot_core_interfaces__action__MoveValue_GetResult_Response * data =
      (denso_robot_core_interfaces__action__MoveValue_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!denso_robot_core_interfaces__action__MoveValue_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          denso_robot_core_interfaces__action__MoveValue_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!denso_robot_core_interfaces__action__MoveValue_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__init(denso_robot_core_interfaces__action__MoveValue_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!denso_robot_core_interfaces__action__MoveValue_Feedback__init(&msg->feedback)) {
    denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__fini(denso_robot_core_interfaces__action__MoveValue_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  denso_robot_core_interfaces__action__MoveValue_Feedback__fini(&msg->feedback);
}
...
denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__are_equal(const denso_robot_core_interfaces__action__MoveValue_FeedbackMessage * lhs, const denso_robot_core_interfaces__action__MoveValue_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!denso_robot_core_interfaces__action__MoveValue_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_FeedbackMessage * msg = (denso_robot_core_interfaces__action__MoveValue_FeedbackMessage *)allocator.allocate(sizeof(denso_robot_core_interfaces__action__MoveValue_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(denso_robot_core_interfaces__action__MoveValue_FeedbackMessage));
  bool success = denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__Sequence__init(denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_FeedbackMessage * data = NULL;

  if (size) {
    data = (denso_robot_core_interfaces__action__MoveValue_FeedbackMessage *)allocator.zero_allocate(size, sizeof(denso_robot_core_interfaces__action__MoveValue_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__Sequence__fini(denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__Sequence * array = (denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__Sequence *)allocator.allocate(sizeof(denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__Sequence__destroy(denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__Sequence__are_equal(const denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__Sequence * lhs, const denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(denso_robot_core_interfaces__action__MoveValue_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    denso_robot_core_interfaces__action__MoveValue_FeedbackMessage * data =
      (denso_robot_core_interfaces__action__MoveValue_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!denso_robot_core_interfaces__action__MoveValue_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
