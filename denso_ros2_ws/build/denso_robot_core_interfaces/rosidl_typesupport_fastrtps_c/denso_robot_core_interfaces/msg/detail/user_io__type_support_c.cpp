...
#include "denso_robot_core_interfaces/msg/detail/user_io__rosidl_typesupport_fastrtps_c.h"
...
using _UserIO__ros_msg_type = denso_robot_core_interfaces__msg__UserIO;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _UserIO__ros_msg_type * ros_message = static_cast<const _UserIO__ros_msg_type *>(untyped_ros_message);
  // Field name: offset
  {
  ...
  void * untyped_ros_message)
{
  ...
  _UserIO__ros_msg_type * ros_message = static_cast<_UserIO__ros_msg_type *>(untyped_ros_message);
  // Field name: offset
  {
    cdr >> ros_message->offset;
  }
...
size_t get_serialized_size_denso_robot_core_interfaces__msg__UserIO(
  const void * untyped_ros_message,
...
static uint32_t _UserIO__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_denso_robot_core_interfaces__msg__UserIO(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_denso_robot_core_interfaces
size_t max_serialized_size_denso_robot_core_interfaces__msg__UserIO(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = denso_robot_core_interfaces__msg__UserIO;
    is_plain =
      (
...
static size_t _UserIO__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_denso_robot_core_interfaces__msg__UserIO(
...
static message_type_support_callbacks_t __callbacks_UserIO = {
...
static rosidl_message_type_support_t _UserIO__type_support = {
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, denso_robot_core_interfaces, msg, UserIO)() {
  return &_UserIO__type_support;
}
