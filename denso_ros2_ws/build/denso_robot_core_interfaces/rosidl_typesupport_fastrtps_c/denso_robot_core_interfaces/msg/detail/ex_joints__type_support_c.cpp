...
#include "denso_robot_core_interfaces/msg/detail/ex_joints__rosidl_typesupport_fastrtps_c.h"
...
#include "denso_robot_core_interfaces/msg/detail/joints__functions.h"  // joints
...
using _ExJoints__ros_msg_type = denso_robot_core_interfaces__msg__ExJoints;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ExJoints__ros_msg_type * ros_message = static_cast<const _ExJoints__ros_msg_type *>(untyped_ros_message);
  // Field name: mode
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ExJoints__ros_msg_type * ros_message = static_cast<_ExJoints__ros_msg_type *>(untyped_ros_message);
  // Field name: mode
  {
    cdr >> ros_message->mode;
  }
  ...
  // Field name: joints
  {
    ...
    if (ros_message->joints.data) {
      denso_robot_core_interfaces__msg__Joints__Sequence__fini(&ros_message->joints);
    }
...
static uint32_t _ExJoints__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_denso_robot_core_interfaces__msg__ExJoints(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = denso_robot_core_interfaces__msg__ExJoints;
    is_plain =
      (
...
static size_t _ExJoints__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_denso_robot_core_interfaces__msg__ExJoints(
...
static message_type_support_callbacks_t __callbacks_ExJoints = {
...
static rosidl_message_type_support_t _ExJoints__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ExJoints,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, denso_robot_core_interfaces, msg, ExJoints)() {
  return &_ExJoints__type_support;
}
