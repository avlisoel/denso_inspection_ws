...
#include "denso_robot_core_interfaces/msg/detail/joints__rosidl_typesupport_fastrtps_c.h"
...
using _Joints__ros_msg_type = denso_robot_core_interfaces__msg__Joints;
...
static uint32_t _Joints__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_denso_robot_core_interfaces__msg__Joints(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = denso_robot_core_interfaces__msg__Joints;
    is_plain =
      (
...
static size_t _Joints__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_denso_robot_core_interfaces__msg__Joints(
