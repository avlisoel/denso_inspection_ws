...
#include "bcap_service_interfaces/msg/detail/variant__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = bcap_service_interfaces::msg::Variant;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const bcap_service_interfaces::msg::Variant *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<bcap_service_interfaces::msg::Variant *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Variant__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const bcap_service_interfaces::msg::Variant *>(
...
static size_t _Variant__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Variant(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Variant__callbacks = {
...
static rosidl_message_type_support_t _Variant__handle = {
...
{
  return &bcap_service_interfaces::msg::typesupport_fastrtps_cpp::_Variant__handle;
}
